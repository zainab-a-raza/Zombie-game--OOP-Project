...
public class Level_1 extends Level{
    ...
    private BasicZombie basicZombie3;
    private BasicZombie basicZombie4;
    private BasicZombie basicZombie5;
    ...
    Level_1() {
        ...
        int bulletOffsetY = bullet.y + 30;

        bullet2 = new Bullet(50, 700 - bulletOffsetY, "/bullet.png");
        bullet3 = new Bullet(700, 700 - bulletOffsetY, "/bullet.png");
        bullet4 = new Bullet(550, 200 - bulletOffsetY, "/bullet.png");
        bullet5 = new Bullet(750, 450 - bulletOffsetY, "/bullet.png");
...
//        m1 = new Warrior(0, 0, "/player.png");
        ...
        basicZombie = new BasicZombie(700, 200 - 87, "/zombies-01.png");
        basicZombie2 = new BasicZombie((1500 / 2) - (699 / 2), 450 - 87, "/zombies-01.png");
        basicZombie3 = new BasicZombie(150, 700 - 87, "/zombies-01.png");
        basicZombie4 = new BasicZombie(750, 700 - 87, "/zombies-01.png");
       // basicZombie5 = new BasicZombie((1500 / 2) - (699/ 2), 850,"/zombies-01.png");


        zombies.add(basicZombie);
        zombies.add(basicZombie2);
        zombies.add(basicZombie3);
        zombies.add(basicZombie4);
      //  zombies.add(basicZombie5);
    }
}
